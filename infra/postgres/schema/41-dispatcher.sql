...
INSERT INTO dispatcher_rules (name, version, status, on_event, when_expr, do_steps, delay, schedule_cadence, schedule_anchor, schedule_calendar) VALUES
  ...
  ('parts-consume-on-production-consume-step-done', 1, 'active', 'step.done.production-consume', NULL, '[{"handler":"inventory.parts.consume","args":{"reason":"\"morning-brew\""}},{"handler":"inventory.overhead.absorb","args":{"rate_cents_per_bbl":"3660","credit_account":"\"6100\"","driver":"\"Direct labor\""}},{"handler":"inventory.overhead.absorb","args":{"rate_cents_per_bbl":"560","credit_account":"\"6300\"","driver":"\"Process utilities\""}},{"handler":"inventory.overhead.absorb","args":{"rate_cents_per_bbl":"860","credit_account":"\"6900\"","driver":"\"Production depreciation\""}}]'::jsonb, NULL, NULL, NULL, NULL),
  ('products-produce-on-production-produce-step-done', 1, 'active', 'step.done.production-produce', NULL, '[{"handler":"products.produce","args":{"cost_basis":"\"drain-actual-wip\"","overhead_accounts":"\"6100,6300,6900\""}},{"handler":"inventory.parts.consume","args":{"reason":"\"morning-brew-packaging\""}}]'::jsonb, NULL, NULL, NULL, NULL),
  ('products-consume-on-invoice-created', 1, 'active', 'commerce.invoice.created', NULL, '[{"handler":"products.consume_from_invoice","args":{}}]'::jsonb, NULL, NULL, NULL, NULL),

...
INSERT INTO dispatcher_rules (name, version, status, on_event, when_expr, do_steps, delay, schedule_cadence, schedule_anchor, schedule_calendar) VALUES
  ...
  ('products-produce-on-production-produce-step-done', 1, 'active', 'step.done.production-produce', NULL, '[{"handler":"products.produce","args":{}},{"handler":"inventory.parts.consume","args":{"reason":"\"morning-brew-packaging\""}}]'::jsonb, NULL, NULL, NULL, NULL),
